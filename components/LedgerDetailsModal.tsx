    ...
    return (
        ...
        >
            ...
            <div className="relative w-full max-w-7xl max-h-[96vh] sm:max-h-[92vh] flex flex-col bg-white dark:bg-slate-900 backdrop-blur-xl border border-slate-200/80 dark:border-slate-800 rounded-xl sm:rounded-2xl shadow-2xl overflow-hidden text-slate-800 dark:text-slate-100">
                ...
                {/* Modal Header */}
                <div className={`flex items-center justify-between px-3.5 py-3 sm:px-5 sm:py-4 border-b border-slate-200/80 dark:border-slate-800 bg-gradient-to-r ${
                    isCreditTheme
                    ...
                    <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
                        <div className={`w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-gradient-to-tr ${
                            ...
                            {isCreditTheme ? (
                                ...
                                <FaArrowDown className="text-sm sm:text-lg" />
                            ) : (
                                <FaExchangeAlt className="text-sm sm:text-lg" />
                            )}
                        </div>
                        <div className="min-w-0">
                            <div className="flex items-center gap-1.5 sm:gap-2">
                                ...
                                <span className={`hidden xs:inline-flex px-2 py-0.5 rounded-full text-[10px] sm:text-xs font-semibold ${
                                    isCreditTheme
                    ...
                    <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
                        ...
                        <button
                            ...
                            className={`flex items-center gap-1.5 px-2.5 py-1.5 sm:px-3 sm:py-1.5 rounded-lg sm:rounded-xl text-[11px] sm:text-xs font-medium ${
                                isCreditTheme
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 p-2.5 sm:p-4 bg-slate-50/70 dark:bg-slate-800/40 border-b border-slate-200/80 dark:border-slate-800 flex-shrink-0">
                    <div className="bg-white dark:bg-slate-800/80 p-2.5 sm:p-3 rounded-lg sm:rounded-xl border border-slate-200/70 dark:border-slate-700/60 shadow-xs flex flex-col justify-between">
                        <span className="text-[10px] sm:text-[11px] font-medium text-slate-500 dark:text-slate-400 flex items-center gap-1 truncate">
                            <FaArrowUp className="text-emerald-500 flex-shrink-0" size={11} /> Total Credit Amount
                        </span>
                    ...
                    <div className="bg-white dark:bg-slate-800/80 p-2.5 sm:p-3 rounded-lg sm:rounded-xl border border-slate-200/70 dark:border-slate-700/60 shadow-xs flex flex-col justify-between">
                        <span className="text-[10px] sm:text-[11px] font-medium text-slate-500 dark:text-slate-400 flex items-center gap-1 truncate">
                            <FaArrowDown className="text-fuchsia-500 flex-shrink-0" size={11} /> Total Debit Amount
                        </span>
                        <span className="text-sm sm:text-base md:text-lg font-bold text-fuchsia-600 dark:text-fuchsia-400 mt-0.5 truncate">
                    ...
                    <div className="bg-white dark:bg-slate-800/80 p-2.5 sm:p-3 rounded-lg sm:rounded-xl border border-slate-200/70 dark:border-slate-700/60 shadow-xs flex flex-col justify-between">
                        <span className="text-[10px] sm:text-[11px] font-medium text-slate-500 dark:text-slate-400 flex items-center gap-1 truncate">
                            <FaRupeeSign className="text-blue-500 flex-shrink-0" size={11} /> Net Ledger Balance
                        </span>
                        <span className={`text-sm sm:text-base md:text-lg font-bold mt-0.5 truncate ${
                    ...
                    <div className="bg-white dark:bg-slate-800/80 p-2.5 sm:p-3 rounded-lg sm:rounded-xl border border-slate-200/70 dark:border-slate-700/60 shadow-xs flex flex-col justify-between">
                        <span className="text-[10px] sm:text-[11px] font-medium text-slate-500 dark:text-slate-400 flex items-center gap-1 truncate">
                            <FaReceipt className="text-slate-500 flex-shrink-0" size={11} /> Total Vouchers
                        </span>
