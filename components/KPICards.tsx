...
export default function KPICards({ kpis }: { kpis: any }) {
    const cards = [
        { title: "Total Sales", value: formatCurrency(kpis?.totalSales), icon: <FaChartLine size={24} /> },
        ...
        { title: "Total Customers", value: kpis?.totalCustomers ?? 0, icon: <FaUsers size={24} /> },

        { title: "Total Products", value: kpis?.totalProducts ?? 0, icon: <FaBoxes size={24} /> },
