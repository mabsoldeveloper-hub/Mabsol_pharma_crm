...
export default function GSTReportsPage() {
    const reports: ReportItem[] = [
        ...
        {
            title: "GSTR-3B",
            desc: "Summary return and tax payment",
            icon: <FaFileInvoiceDollar size={16} />,
            link: "/dashboard/reports/gst-reports/gstr3b",
            color: "cyan",
        },
        {
            title: "GSTR-2B",
            desc: "Auto-generated ITC statement",
            icon: <FaShoppingCart size={16} />,
            link: "/dashboard/reports/gst-reports/gstr2b",
            color: "emerald",
        },
        {
            title: "Sales Register",
            desc: "GST-wise sales invoices",
            icon: <FaUsers size={16} />,
            link: "/dashboard/reports/gst-reports/sales-register",
            color: "amber",
        },
        {
            title: "Purchase Register",
            desc: "GST-wise purchase invoices",
            icon: <FaBoxOpen size={16} />,
            link: "/dashboard/reports/gst-reports/purchase-register",
            color: "violet",
        },
    ];
                ...
                `}
                  ...
                  `}
                                ...
                                <div className="min-w-0">
                                    ...
                                    <div
                                        className={`
                      inline-flex items-center gap-1 mt-2 text-[11px]
                      font-medium ${c.iconText}
                    `}
                                    >
                                        View Report
                                        <FaArrowRight size={8} />
